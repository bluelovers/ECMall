...
ENABLED_SUBDOMAIN : 二級域名功能開關,0為關閉,1為開啟,開啟時必須配置SUBDOMAIN_SUFFIX.二級域名功能開啟方法請查看安裝包中docs目錄下的二級域名配置相關文檔.

SUBDOMAIN_SUFFIX : 二級域名後綴,例如:用戶的二級域名將是"test.mall.example.com", 則您只需要在此填寫"mall.example.com".
*/
